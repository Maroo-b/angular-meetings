myApp.factory('Authentication', ["$firebaseAuth", "$firebaseArray", "$firebaseObject", "$rootScope", "$routeParams", "$location", "FIREBASE_URL", function( $firebaseAuth, $firebaseArray, $firebaseObject, $rootScope, $routeParams, $location, FIREBASE_URL) {
